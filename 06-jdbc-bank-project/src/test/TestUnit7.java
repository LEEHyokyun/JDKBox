...
public class TestUnit7 {
	public static void main(String[] args) {
		...
		try {
			...
			// System.out.println("이체전 송금자
			// 계좌잔액:"+dao.findBalanceByAccountNo(senderAccountNo, password));
			// System.out.println("이체전 수금자
			// 계좌잔액:"+dao.findBalanceByAccountNo(receiverAccountNo, "1"));
			dao.transfer(senderAccountNo, password, money, receiverAccountNo);
			// System.out.println(money+"원 계좌이체완료");
			// System.out.println("이체후 송금자
			// 계좌잔액:"+dao.findBalanceByAccountNo(senderAccountNo, password));
			// System.out.println("이체후 수금자
			// 계좌잔액:"+dao.findBalanceByAccountNo(receiverAccountNo, "1"));
			...
			System.out.println(e.getMessage()); // 출금액이 잔액보다 큰 경우 출금불가
